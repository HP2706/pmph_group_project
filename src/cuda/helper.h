...
struct Params {
    ...
    static constexpr int NUM_BLOCKS = _NUM_BLOCKS; // number of blocks per grid
    static constexpr int BLOCK_SIZE = _BLOCK_SIZE; // number of threads per block
    static constexpr int TILE_SIZE = _T; // Tile size
...
template<class ElTp, class UintTp, int _Q, int _lgH, int _NUM_BLOCKS, int _BLOCK_SIZE, int _T>
struct is_params<Params<ElTp, UintTp, _Q, _lgH, _NUM_BLOCKS, _BLOCK_SIZE, _T>> : std::true_type {};
